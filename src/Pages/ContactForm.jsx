...
const ContactForm = () => {
    ...
    const onSubmit = (e) => {
        ...
        fetch('https://script.google.com/macros/s/AKfycbwdehCKGyUxkeXRQDbYCNkuxZHFZXEXsajSss8wqkTdozL1dwYg6l8eFqrEZIZFlHSQhg/exec', { method: 'POST', body: new FormData(form) })
            ...
            .then(() => alert('Thank You For Contacting Us... We Will Reachout Soon!!'))
    ...
    return (
        <>
            ...
            <form action='https://script.google.com/macros/s/AKfycbwdehCKGyUxkeXRQDbYCNkuxZHFZXEXsajSss8wqkTdozL1dwYg6l8eFqrEZIZFlHSQhg/exec' onSubmit={onSubmit}
                method="POST" name='Contactform' id='Contactform' className='space-y-6 h-auto w-auto flex justify-center flex-col items-center text-white bg-[#061034] pb-6 overflow-hidden mb:h-auto mb:w-auto'>
                <button className="py-2.5 px-5 mr-2 mb-2 font-medium text-white focus:outline-none bg-gradient-to-r from-[#22BBFD] via-[#905EF8] to-[#D621F4] rounded-lg border border-gray-200 hover:bg-black hover:text-white focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 flex justify-center items-center text-lg pl-3 btn_hover"> <Link to='/' > {'<-'} Back To Home</Link></button>

                <h2 className='font-Poppins lg:text-4xl text-[#22BBFD] mb:text-center lg:text-left mb:text-2xl'>Enquiry
                    Form</h2>
                <div className='border-2 border-cyan-400  outlinenone py-2 lg:w-[27rem]  px-8 space-x-5 flex items-center justify-start rounded-xl mb:w-auto'>
                    <span className='pt-2'><ion-icon style={{ color: "white", fontSize: '1.6rem' }} name="person"></ion-icon></span>
                    <input type="text" required name="Name" className='outline-none border-none font-Poppins font-[300] bg-transparent  mb:w-52' placeholder='Your Name' autoComplete='off' />
                </div>
                <div className='border-2 border-cyan-400  py-2  lg:w-[27rem] px-8 flex items-center justify-start space-x-5 rounded-xl mb:w-auto'>
                    <span className='pt-2'><ion-icon style={{ color: "white", fontSize: '1.6rem' }} name="location"></ion-icon></span>
                    {/* <input type="text" name="country" value={Data.country} onChange={handleInput} className='outline-none border-none font-Poppins font-[300] bg-transparent' placeholder='Your Country' /> */}
                    <select type="text" required name="Country" className='outline-none border-none font-Poppins font-[300] text-white w-80 bg-[#061034] mb:w-52' placeholder='Your Country' id="country" >
                ...
                <div className='border-2 border-cyan-400 py-2 lg:w-[27rem] px-8 flex items-center justify-start space-x-5 rounded-xl mb:w-auto'>
                    <span className='pt-2'><ion-icon style={{ color: "white", fontSize: '1.6rem' }} name="call"></ion-icon></span>

                    <input type="text" required name="Number" className='outline-none border-none font-Poppins font-[300] bg-transparent w-72   mb:w-52' placeholder='Your Number' autoComplete='off' />
                </div>

                <div className='border-2 border-cyan-400  py-2 lg:w-[27rem] px-8 flex items-center justify-start space-x-5 rounded-xl mb:w-auto'>
                    <span className='pt-2'><ion-icon style={{ color: "white", fontSize: '1.6rem' }} name="chatbubble-ellipses"></ion-icon></span>
                    <input type="text" required name="Message" className='outline-0 border-none font-Poppins font-[300] bg-transparent outline-none   mb:w-52' placeholder='Your Message' autoComplete='off' />
                </div>
